...
var TestComponent = mobx_react_lite_1.observer(function () {
    var setGetData = __1.useGetDataApi().setGetData;
    // React.useEffect(() => {
    // 	setGetData({
    ...
    // 	});
    // }, []);
    return react_1["default"].createElement("div", null, "here");
});
describe("getApiHook이 정확히 작동하는지 검증한다..", function () {
    ...
    test("store에 통신 성공한 데이터가 정확한 값으로 업데이트 되는지 검증한다.", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store = RootStore_1.rootStore;
                    return [4 /*yield*/, react_2.waitFor(function () { return expect(store.fetchStore.response.userId).toBe("1"); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
